...
local config = {
  ...
  cmd = {
    ...
    "-Dlog.protocol=true",
    "-Dlog.level=ALL",
    -- "-javaagent:" .. home .. "/Documents/Builds/jdtls/lombok.jar",
    "-Xms1g",
    ...
    -- 💀
    "-jar",
    vim.fn.glob(home .. "/Documents/Builds/jdtls/plugins/org.eclipse.equinox.launcher_*.jar"),
    -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
    ...
    -- 💀
    "-configuration",
    home .. "/Documents/Builds/jdtls/config_" .. CONFIG,
    -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
